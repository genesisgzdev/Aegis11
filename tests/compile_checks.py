...
require("include/Core/StateEngine.hpp", 'RestoreBaseline')
require("include/Core/State.hpp", 'schemaVersion = "1"')
require("include/Core/State.hpp", 'std::vector<std::uint8_t> data')
require("include/Modules/RegistryManager.hpp", 'RegQueryValueExW(hk.get(), target.key.c_str(), nullptr, &type, nullptr, &size)')
require("include/Modules/TaskManager.hpp", 'task->get_Xml')
require("include/Modules/ServiceManager.hpp", 'state.dependencies.push_back')
...
require("src/main.cpp", 'state.RestoreBaseline(runConfig.restore_file, engine)')
